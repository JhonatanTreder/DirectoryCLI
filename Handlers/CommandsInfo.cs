...
namespace DirectoryCLI.Handlers
{
    internal class CommandsInfo : CommandsConfig
    {
        ...
        public static void Commands()
        {
            ...
            table.AddRow(Markup.Escape("[zip]"), "Move um arquivo ou pasta para um diretório de destino.");
            table.AddRow(Markup.Escape("[list]"), "Lista o conteúdo de um diretório/caminho especificado.");
            table.AddRow(Markup.Escape("[scan]"), "Mostra o tamanho total de um caminho especificado.");
            table.AddRow(Markup.Escape("[open]"), "Abre um arquivo ou pasta de um diretório especificado (use o parâmetro --this para abrir o próprio diretório).");
            ...
            table.AddRow(Markup.Escape("[dotnet]"), "Compatibilidade com o uso de comandos do dotnet ('dotnet new list', 'dotnet --version', 'dotnet --info', etc...).");
        ...
        public static void CommandSintaxe()
        {
            ...
            table.AddRow(Markup.Escape("[list]"), "<diretório> <list>");
            ...
            table.AddRow(Markup.Escape("[del-files]"), "<diretório> <del-files> (pode especificar o tipo de extensão para apagar arquivos com somente essa extensão)");
            table.AddRow(Markup.Escape("[del-folders]"), "<diretório> <del-folders>.");
            table.AddRow(Markup.Escape("[system-info]"), "<system-info>");
            table.AddRow(Markup.Escape("[dotnet]"), "<dotnet> <parâmetros...>");

...
## Funcionalidades
Esse projeto de código aberto possui diversas funcionalidades básicas, como a manipulação de arquivos/diretórios em larga escala, realizar diagnósticos do Sistema Operacional, abrir sites, utilizar comandos de outras CLIs (como o docker, git, do próprio SO, etc...).
